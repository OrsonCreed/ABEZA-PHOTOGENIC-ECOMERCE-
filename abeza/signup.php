...
<!-- Custom Theme files -->
<link href="assets/css/style-starter.css" rel="stylesheet" type="text/css" media="all" />
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="signup.php" method="post">
					...
					<input class="text w3lpass" type="password" name="password_retype" placeholder="Confirm Password" required="">
          ...
          <div class="container py-lg-5">
              ...
              <div class="below-section row">
                  ...
                  <div class="columns col-lg-6 text-lg-right">
                      <p>© 2021 ABEZA Photogenic. All rights reserved
                      </p>
                  </div>
